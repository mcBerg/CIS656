...
public class VectorClockTests {
	...
	public void testClockSortingThree() {
		...
		priorityQueue.add(e);
		priorityQueue.add(f);
		assertEquals("[{\"0\":1}, {\"0\":2}, {\"1\":1}, {\"0\":1,\"1\":1,\"2\":1}, {\"1\":2}, {\"0\":2,\"1\":2,\"2\":2}]", priorityQueue.toString());
		
		priorityQueue = new PriorityQueue<VectorClock>(new VectorClockComparator());
		priorityQueue.add(f);
		priorityQueue.add(e);
		priorityQueue.add(d);
		priorityQueue.add(c);
		priorityQueue.add(b);
		priorityQueue.add(a);
		assertEquals("[{\"0\":1}, {\"1\":1}, {\"0\":1,\"1\":1,\"2\":1}, {\"0\":2}, {\"1\":2}, {\"0\":2,\"1\":2,\"2\":2}]", priorityQueue.toString());
