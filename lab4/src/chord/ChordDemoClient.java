...
public class ChordDemoClient {

	Chord chord;
	
    public ChordDemoClient(String masterHost, boolean master)
    {
		try {
			if(master) {
	...
	public void createNetwork(String host)
	{
		...
		URL localURL = null;
		try {
			localURL = new URL(protocol + "://" + InetAddress.getLocalHost().getHostAddress() + ":" + 8080 + "/");
	...
	public static void main(String[] args) {
		...
		ChordDemoClient client = new ChordDemoClient(args[1], theMaster );
